...
--
-- Execute this script in MySQL 8.x.
-- ================================================================
...
-- Helpful indexes for common lookup/join/filter operations.
...
-- Mark currently rented vehicles after inserting active rentals.
UPDATE Vehicle
SET Status = 'RENTED'
WHERE VehicleID IN (
    SELECT VehicleID
...
-- Q1. Customer name, vehicle number/model, rental and return dates.
SELECT
    c.CustomerName,
    v.VehicleNumber,
    v.VehicleModel,
...
-- Q2. All customers and vehicles they have rented, including customers
--     who have never rented.
SELECT
    c.CustomerName,
    v.VehicleNumber,
    v.VehicleModel,
...
-- Q3. All vehicles and current rental information, including vehicles
--     that are not currently rented.
SELECT
    v.VehicleNumber,
    v.VehicleModel,
...
-- Q4. Total number of rentals by each customer, including zero.
SELECT
    c.CustomerID,
    c.CustomerName,
